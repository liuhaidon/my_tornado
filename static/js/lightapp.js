! function() {
	window._CLOUDA_HASHMAP_ = {}, window._CLOUDA_HASHMAP_.res = {
		...
		"device/fs": {
			src: "/s/fs_581e9e9.js",
			pkg: "/pkg/fs-media_46b55f4.js"
		},
		"device/geolocation": {
			src: "/s/geolocation_8d41e6c.js"
		},
		...
		"lego/boostNativeBgPageDataSender": {
			src: "/s/boostNativeBgPageDataSender_f57c01f.js"
		},
		"lego/boostNativeBgPageDataSender_v2.1": {
			src: "/s/boostNativeBgPageDataSender_v2.1_003668e.js"
		},
		"lego/boostNativeSmartBar": {
			src: "/s/boostNativeSmartBar_73d8e46.js"
		},
		"lego/boostNativeSmartBar_v2.0": {
			src: "/s/boostNativeSmartBar_v2.0_22b3e59.js"
		},
		"lego/boostNativeSmartBar_v2.1": {
			src: "/s/boostNativeSmartBar_v2.1_b00a5a4.js"
		},
		"lego/boostNativeSmartBar_v2.2": {
			src: "/s/boostNativeSmartBar_v2.2_bdb8d5e.js"
		},
		"lego/boostNativeSmartBar_v2.3": {
			src: "/s/boostNativeSmartBar_v2.3_c335a55.js"
		},
		"lego/monitor": {
			src: "/s/monitor_17191c7.js",
			pkg: "/pkg/helper-utils-moplus-monitor_cccb3ce.js"
		},
		"lego/o2oSmartBar": {
			src: "/s/o2oSmartBar_f5fee65.js"
		},
		"lego/smartBar": {
			src: "/s/smartBar_a84ba96.js",
			pkg: "/pkg/push-smartBar_f0a0b3a.js"
		},
		"lib/helper": {
			src: "/s/helper_e16d823.js",
			pkg: "/pkg/helper-utils-moplus-monitor_cccb3ce.js"
		},
		"lib/moplus": {
		...
		"lib/o2o": {
			src: "/s/o2o_061d704.js"
		},
		"lib/utils": {
			src: "/s/utils_74ec880.js",
			pkg: "/pkg/helper-utils-moplus-monitor_cccb3ce.js"
		},
		"mbaas/account": {
			src: "/s/account_d54829c.js",
			pkg: "/pkg/account-pay_6c1fe41.js"
		},
		"mbaas/alipay": {
			src: "/s/alipay_63cd99c.js"
		},
		"mbaas/app": {
			src: "/s/app_2488902.js",
			pkg: "/pkg/app-socialshare_b5c9f0e.js"
		},
		"mbaas/consult": {
			src: "/s/consult_275e3fe.js"
		},
		"mbaas/face": {
			src: "/s/face_b1e114e.js"
		},
		"mbaas/feedback": {
			src: "/s/feedback_818dd59.js"
		},
		"mbaas/map": {
			src: "/s/map_4a0eeb0.js"
		},
		"mbaas/mbaas": {
			src: "/s/mbaas_cf1f6f9.js"
		},
		"mbaas/pay": {
			src: "/s/pay_9571121.js",
			pkg: "/pkg/account-pay_6c1fe41.js"
		},
		"mbaas/pcs": {
		...
		"mbaas/push": {
			src: "/s/push_976656f.js",
			pkg: "/pkg/push-smartBar_f0a0b3a.js"
		},
		"mbaas/socialshare": {
			src: "/s/socialshare_b9595c8.js",
			pkg: "/pkg/app-socialshare_b5c9f0e.js"
		},
		"mbaas/subscribe": {
			src: "/s/subscribe_0bfdf59.js"
		},
		"mbaas/vtt_tts": {
...
! function(e, n) {
	function t(e, t) {
		...
		if(u(m, e)) t && t();
		else if(u(_, e)) _[e] = _[e] || [], _[e].push(t);
		else {
			_[e] = [];
	...
	function a(e) {
		var n = [];
		if(e && e.length > 0)
			for(var t = 0, r = e.length; r > t; t++) "require" !== e[t] && "exports" !== e[t] && "module" !== e[t] && n.push(e[t]);
		return n
	}
	...
	("undefined" == typeof e._define_ || "undefined" == typeof e._require_) && (v = function(e, n, t) {
		...
		function r() {
			if(x.length > 0)
				for(var t = null; t = x.shift();) t && p.sync(t);
		...
		if(n.exports = t = {}, r = n.deps)
			for(var a = r.length, l = 0; a > l; l++) {
				var f = r[l];
...
! function(win, doc) {
	function execApiStack(modules) {
		...
		if(modulesLen)
			for(var stackIndex = 0; modulesLen > stackIndex; stackIndex++) eval(modules[stackIndex].func).apply(null, modules[stackIndex].arg)
	}
			...
			initApiStack(defautAPI), clouda.lightInit = function(e, t) {
				...
				if(a.length > 0) {
					for(var i = 0, n = a.length; n > i; i++)
						if("vtt_tts" == a[i]) a.push("vtt"), a.push("tts");
						else if("blendui" == a[i]) {
						var c = /BlendUI/i;
				...
				o2oVersion >= "2.2" && r.push("lib/o2o"), clouda.require(r, function() {
					...
					if(i[n] = 1 * new Date, !win.hasOpenJS && o) {
						if("http:" === window.location.protocol) var c = "http://static2.searchbox.baidu.com/static/searchbox/openjs/aio.js?v=201502";
						else var c = "https://m.baidu.com/static/searchbox/openjs/aio.js?v=201502";
...
! function() {
	...
	function d(a, e, d) {
		if("[object Array]" != Object.prototype.toString.apply(a)) {
			...
			for(var b = (a.length, 0), o = a.length; o > b; b++) c(a[b], b, o)
	}
	...
	function f(a, e, c) {
		if(null !== a && "undefined" != a || null !== e && "undefined" !== e) {
			...
			var f = localStorage.getItem("xnSmartBarCacheKey_" + a),
				b = {};
			f && (b.defer = !0);
			var o = t;
