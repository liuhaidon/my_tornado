...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server config1 not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server config1 error.',
    'loadconfigFormatError': 'Server config1 format error.',
    'loadconfigHttpError': 'Get server config1 http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the config1!",
