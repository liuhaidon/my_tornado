...
SVGRenderer.prototype = {
	 ...
	 *
	 * @param {Object} color The color or config1 object
	 */
	color: function (color, elem, prop) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same config1 object is created within this renderer
			if (gradients[key]) {
				id = gradients[key].id;
...
Axis.prototype = {
	...
	/** 
	 * The default label formatter. The context is a special config1 object for the label.
	 */
...
Chart.prototype = {
	 ...
	 *
	 * @param {Object} options The config1 options
	...
	/**
	 * Create the Axis instances based on the config1 options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original config1 options for
...
Series.prototype = {
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			// a specific marker config1 object is defined for the individual point:
			...
			// no marker config1 object is created: copy a reference to the series-wide
